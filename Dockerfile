...
RUN apt update && apt install -y software-properties-common zip wget curl git
...
RUN cd /home && git clone https://github.com/souying/APP.git pack && cd pack && chmod 777 ./bin/www && npm install && mkdir app tmle && chmod -R 777 /home/pack
